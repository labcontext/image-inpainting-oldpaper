...
try:
    os.makedirs("result_1/train/cropped")
    os.makedirs("result_1/train/real")
    os.makedirs("result_1/train/recon")
    os.makedirs("model_1")
except OSError:
    pass
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        if i % 150 == 0:
            vutils.save_image(real_cpu,
                              'result_1/train/real/real_samples_epoch_%03d.png' % (epoch))
            vutils.save_image(input_cropped.data,
                              'result_1/train/cropped/cropped_samples_epoch_%03d.png' % (epoch))
            ...
            vutils.save_image(recon_image.data,
                              'result_1/train/recon/recon_center_samples_epoch_%03d.png' % (epoch))

    # do checkpointing
    torch.save({'epoch': epoch+1,
                'state_dict': netG.state_dict()},
               'model_1/netG_oldDB.pth')
    torch.save({'epoch': epoch+1,
                'state_dict': netD.state_dict()},
               'model_1/netlocalD.pth')
